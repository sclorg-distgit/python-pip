...
Provides: %{?scl_prefix}bundled(python%{1}dist(appdirs)) = 1.4.3
Provides: %{?scl_prefix}bundled(python%{1}dist(CacheControl)) = 0.12.5
Provides: %{?scl_prefix}bundled(python%{1}dist(certifi)) = 2019.6.16
Provides: %{?scl_prefix}bundled(python%{1}dist(chardet)) = 3.0.4
Provides: %{?scl_prefix}bundled(python%{1}dist(colorama)) = 0.4.1
Provides: %{?scl_prefix}bundled(python%{1}dist(distlib)) = 0.2.9.post0
Provides: %{?scl_prefix}bundled(python%{1}dist(distro)) = 1.4.0
Provides: %{?scl_prefix}bundled(python%{1}dist(html5lib)) = 1.0.1
Provides: %{?scl_prefix}bundled(python%{1}dist(idna)) = 2.8
Provides: %{?scl_prefix}bundled(python%{1}dist(ipaddress)) = 1.0.22
Provides: %{?scl_prefix}bundled(python%{1}dist(lockfile)) = 0.12.2
Provides: %{?scl_prefix}bundled(python%{1}dist(msgpack)) = 0.6.1
Provides: %{?scl_prefix}bundled(python%{1}dist(packaging)) = 19.0
Provides: %{?scl_prefix}bundled(python%{1}dist(pep517)) = 0.5.0
Provides: %{?scl_prefix}bundled(python%{1}dist(progress)) = 1.5
Provides: %{?scl_prefix}bundled(python%{1}dist(pyparsing)) = 2.4.0
Provides: %{?scl_prefix}bundled(python%{1}dist(pytoml)) = 0.1.20
Provides: %{?scl_prefix}bundled(python%{1}dist(requests)) = 2.22.0
Provides: %{?scl_prefix}bundled(python%{1}dist(retrying)) = 1.3.3
Provides: %{?scl_prefix}bundled(python%{1}dist(setuptools)) = 41.0.1
Provides: %{?scl_prefix}bundled(python%{1}dist(six)) = 1.12.0
Provides: %{?scl_prefix}bundled(python%{1}dist(urllib3)) = 1.25.3
Provides: %{?scl_prefix}bundled(python%{1}dist(webencodings)) = 0.5.1
}
